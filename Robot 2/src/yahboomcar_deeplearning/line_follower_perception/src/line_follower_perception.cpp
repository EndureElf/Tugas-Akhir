...
LineFollowerPerceptionNode::LineFollowerPerceptionNode(const std::string& node_name,
  ...
  this->declare_parameter("model_path", "/home/sunrise/yahboomcar_ws/src/yahboomcar_deeplearning/line_follower_perception/config/resnet18_224x224_nv12.bin");
